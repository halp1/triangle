...
(() => {
  ...
  ex.circularDeepEqual = circularDeepEqual;
  ex.circularShallowEqual = circularShallowEqual;
  ex.createCustomEqual = createCustomEqual;
  ex.deepEqual = deepEqual;
  ex.sameValueZeroEqual = sameValueZeroEqual;
  ex.shallowEqual = shallowEqual;
  ex.strictCircularDeepEqual = strictCircularDeepEqual;
  ex.strictCircularShallowEqual = strictCircularShallowEqual;
  ex.strictDeepEqual = strictDeepEqual;
  ex.strictShallowEqual = strictShallowEqual;
